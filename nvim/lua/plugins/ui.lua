...
return {
	-- Catppuccin theme (VS Code-like modern look)
	{
		"catppuccin/nvim",
		name = "catppuccin",
		priority = 1000,
	...
	-- Better UI for notifications, cmdline and popupmenu
	{
		"folke/noice.nvim",
		event = "VeryLazy",
		opts = {
	...
	-- VS Code-like active indent guide and indent text objects
	{
